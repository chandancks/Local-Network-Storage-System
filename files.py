...
sp.getoutput("sudo sshpass -p redhat ssh -o stricthostkeychecking=no -l root 192.168.43.102 mount /dev/storage_sea/{0} /logical_mount/{1}".format(user_id,user_id))
